      ...
      <center>
        <main className='container mx-auto'>
          <div className='w-full bg-slate-200 mt-10 rounded-md mb-1 text-4xl bg-gradient-to-r from-purple-500 to-pink-500'>
            <p className='p-2 text-slate-700 font-bold'>Work Reccommend</p>
          </div>
          ...
          <div className='grid grid-cols-4 justify-items-center gap-1 items-center mt-2 box-border center'>
            ...
            {jobData.map((job: any) => (
              <div className="card w-75 bg-base-100 shadow-xl hover:shadow-amber-400 duration-1000 cursor-pointer" key={job.JobID} onClick={() => handleCardClickJOB(job)}>
          ...
          <div className='w-full bg-slate-200 mt-10 rounded-md mb-1 text-4xl bg-gradient-to-r from-purple-500 to-pink-500'>
            <p className='p-2 text-slate-700 font-bold'>Empolyee Reccommend</p>
          </div>
          ...
          <div className='grid grid-cols-4 justify-items-center gap-1 items-center mt-2 box-border center'>
            {cvData.map((cv: any) => (
              <div className="card w-75 bg-base-100 shadow-xl hover:shadow-amber-400 duration-1000 cursor-pointer" key={cv.CvID} onClick={() => handleCardClickCV(cv)}>
                <figure className='h-52'>
