        ...
        <>
            ...
            <center className='grid'>
                <div className='self-center h-3/4'>
                    {EmpData.map(emp => (
                        <div className='container grid grid-cols-3 justify-center center bg-slate-700 center rounded-2xl gap-1' key={emp.UserID}>
                                ...
                                <div className='pb-5'>
                                    <div>
                                        ...
                                        <div className='grid grid-cols-3 justify-self-center pb-2'>
                                            ...
                                            <div className='col-span-2 justify-self-start'>
                                                {emp.VillageName ? (
                                                    <p className=''>{emp.VillageName} / {emp.DistrictName} / {emp.ProvinceName}</p>
                                                ) : (
                                        ...
                                        <div className='grid grid-cols-3 '>
                                            ...
                                            {emp.ProfessionalTitle ? (
                                                    <p className=''>{emp.ProfessionalTitle}</p>
                                                ) : (
                                    ...
                                    <div>
                                        <button className='btn btn-square btn-wide btn-ghost btn-outline md:mt-6 mt-2 '> Edit mode</button>
