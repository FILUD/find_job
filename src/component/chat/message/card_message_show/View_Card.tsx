...
function View_Card({ isOpen, isClose, data, type }: Toggle) {
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className='w-full max-w-md  card w-200 bg-base-100 shadow-xl transition-all'>
                                    ...
                                    <div>
                                        <div className='card card-side shadow-xl bg-base-300 m-4' >
                                            <div className='card-body'>
                                                <figure className=''>
                                                    <a href={data.IMG_Card} target="_blank" rel="noopener noreferrer" onClick={handleFullScreen}>
                                                        <img id="fullScreenImage" src={data.IMG_Card} data-original-url={data.IMG_Card} alt="Movie" className='rounded-xl' />                                                    </a>
                                                    {/* <img id="fullScreenImage" src={data.IMG_Card} alt="Movie" className='rounded-xl' /> */}
                                                </figure>
                                                <button className='btn btn-outline btn-primary' onClick={handleFullScreen}>Full screen</ button>
                                            </div>
                                        </div>
                                        {type == "jobseeker" ? (
                                            ...
                                            <div>
                                                {data.Status == "Pending" ? (
                                                    ...
                                                    <div className='flex flex-row space-x-4 m-4 justify-end'>
                                                        <button className='btn btn-outline btn-primary'>Accepted</ button>
                                                        <button className='btn btn-outline' onClick={isClose}>Close</button>
                                                    </div>
                                                )}
                                            </div>
