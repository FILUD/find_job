                                        ...
                                        <div className='card card-side bg-base-300 shadow-xl m-4  w-fit' >
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className='text-sm text-start'>
                                                    ...
                                                    <p>ໝວດຫມູ່ອາຊີບ : {data.CategoryName}</p>
                                                </div>
                                                <div className="stats bg-primary text-primary-content">
                                                    <div className="stat">
                                                        <div className="stat-title text-black">ເງິນເດືອນເລີ່ມຕົ້ນ (ກີບ)</div>
                                                        <div className="stat-value">{data.SalaryStart}</div>
                                                    </div>

                                                    <div className="stat">
                                                        <div className="stat-title text-black">ເງິນເດືອນສູງສຸດ (ກີບ)</div>
                                                ...
                                                {data.Status == "Pending" ? (
                                                    <div className="flex flex-row m-4">
                                                        ...
                                                        <div className="flex justify-end flex-1 space-x-4">
                                                            ...
                                                            <button className="btn btn-outline" onClick={isClose}>ປຶດ</button>
                                                        </div>
                                                    </div>
                                                ) : (
                                                    <div className="flex flex-row m-4">
