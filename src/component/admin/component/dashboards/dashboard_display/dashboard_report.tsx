...
import ReportVisitForm from './report/form/report_visitweb_form';

const Dashboard_report: React.FC = () => {
    const [title, setTitle] = useState('');
    const componentRef = useRef<any>(null);
    const [showPDF, setShowPDF] = useState(false);
    const [selectReport, setSelectReport] = useState('report_visit_web');
                ...
                <div className="p-8 space-y-4 bg-base-100 h-fit bg-opacity-100 rounded-2xl">
                    ...
                    <div className="flex justify-center">
                        <select className="select select-primary w-full max-w-xs font-notoLao"
                            ...
                            <option value={"report_visit_web"} >ລາຍງານສະຖິຕິຜູ້ເຂົ້າໃຊ້ເວັບໄຊ</option>
                            <option value={"report_user"} >ລາຍງານສະຖິຕິຜູ້ສະໝັກບັນຊີ</option>
