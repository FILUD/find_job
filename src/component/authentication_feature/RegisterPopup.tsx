                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            ...
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-8 text-left align-middle shadow-xl transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="red-500" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className="w-14 h-14 transition hover:scale-125 absolute top-0 right-0 hover:fill-red-700  " onClick={onClose}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                </svg>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-8 h-8 transition hover:scale-125 absolute top-4 left-4 " onClick={togglePopup}>
                                ...
                                {isLoading ? (
                                    ...
                                    <div className="mt-2 font-sans font-semibold">
                                        ...
                                        <div className="px-1 font-sans font-semibold grid grid-cols-2 space-x-2 mb-5">
                                            <input placeholder='Firstname' id="name" name="name" type="text" autoComplete="given-name" required className={formInputCss} />
                                            <input placeholder='Lastname' id="lastname" name="lastname" type="text" autoComplete="family-name" required className={formInputCss} />
                                        </div>
                                        ...
                                        <br></br>
                                        <input placeholder='Password' value={password} type="password" autoComplete="new-password" required className={formInputCss} onChange={(e) => setPassword(e.target.value)} />
                                        <br></br>
                                        <input placeholder='Confirm Password' type="password" autoComplete="new-password" required className={formInputCss} />
                                    </div>
                                )}
