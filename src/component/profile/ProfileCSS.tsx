const cssProfile = {
    titleName: 'font-sans 2xl:text-3xl xl:text-3xl lg:text-3xl md:text-2xl sm:text-2xl text-xl font-bold mt-2.5',
    titleWork: 'font-sans 2xl:text-lg xl:text-lg lg:text-lg md:text-lg sm:text-base text-sm font-normal mb-2 mt-2',
    titleAddress: 'ml-2 font-sans 2xl:text-sm xl:text-sm lg:text-xs md:text-xs sm:text-xs text-xs',
