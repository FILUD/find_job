...
const ReportJobseeker: React.FC<ReportProps> = ({ componentRef, title }) => {
        ...
        <div ref={componentRef} className='bg-white  '>
            <div id='page1' className='h-[1000px] py-16 px-10 text-black font-notoLao'>
                ...
                <h2 className='text-2xl font-semibold text-center my-6 '>
                    <p>ລາຍງານຂໍ້ມູນຄຳເຊີນເຂົ້າເຮັດວຽກ</p>
                </h2>
                ...
                <Card className='font-notoLao text-black'>
                    <p className="font-semibold my-4 text-center">ຂໍ້ມູນບໍລິສັດທີ່ຕອບຮັບທັງໝົດ</p>
                    ...
                    <table className=''>
                        <thead className="bg-slate-800  outline outline-1 outline-base-100  ">
                            <tr className="text-sm outline outline-1 hover">
                                ...
                                <th className="text-gray-400 outline outline-1 w-2/6">ຊຶ່ບໍລິສັດ</th>
...
export default ReportJobseeker;
